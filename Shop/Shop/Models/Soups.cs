...
namespace Shop.Models
{
    class Soups:Product
    {
        ...
        public Soups(string UsePlace)
        {
            this.useplace = UsePlace;
        }
        public Soups(string UsePlace, string ProductName) : base(ProductName)
        {
            this.productname = ProductName;
        }
        public Soups(string UsePlace, string ProductName, string ProductDescription) : base(ProductName, ProductDescription)
        {
            this.productdescription = ProductDescription;
        }
        public Soups(string UsePlace, string ProductName, string ProductDescription, int ProductCount) : base(ProductName, ProductDescription, ProductCount)
        {
